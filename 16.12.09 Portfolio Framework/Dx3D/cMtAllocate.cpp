...
STDMETHODIMP cMtAllocate::CreateFrame(
	THIS_ LPCSTR Name,
...
STDMETHODIMP cMtAllocate::CreateMeshContainer(
	THIS_ LPCSTR Name,
...
STDMETHODIMP cMtAllocate::DestroyFrame(
...
STDMETHODIMP cMtAllocate::DestroyMeshContainer(
