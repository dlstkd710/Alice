...
public:
	...
	void Setup();
	//void Setup(cMtMesh* pMtMesh);
	//void Setup(cObjectXfile* pObjMesh);
	void Setup(D3DXVECTOR3 pMin, D3DXVECTOR3 pMax);
	void Update(D3DXMATRIXA16* pmatWorld);
	void DebugRender(D3DCOLOR c);

	static bool IsCollision(cOBB* pOBB1, cOBB* pOBB2);
	static bool IsCollision(cOBB* pOBB1, D3DXVECTOR3 pVec);
};
