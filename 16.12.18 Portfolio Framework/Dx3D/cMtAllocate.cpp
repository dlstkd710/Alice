...
STDMETHODIMP cMtAllocate::CreateFrame(THIS_ LPCSTR Name, LPD3DXFRAME *ppNewFrame)
{
...
STDMETHODIMP cMtAllocate::CreateMeshContainer(THIS_ LPCSTR Name,
	...
	LPD3DXMESHCONTAINER *ppNewMeshContainer)
{
	...
	if (pMeshData && pMeshData->pMesh)
	{
		...
		D3DXComputeBoundingBox((D3DXVECTOR3*)pV,
			...
			&vMin,
			&vMax);
		D3DXVec3Minimize(&m_Min, &m_Min, &vMin);
		D3DXVec3Maximize(&m_Max, &m_Max, &vMax);
...
STDMETHODIMP cMtAllocate::DestroyFrame(THIS_ LPD3DXFRAME pFrameToFree)
{
...
STDMETHODIMP cMtAllocate::DestroyMeshContainer(THIS_ LPD3DXMESHCONTAINER pMeshContainerToFree)
{
