...
void EffectClass::Render(D3DXMATRIXA16 * trans)
{
	...
	D3DXMatrixRotationY(&matR, 각도(plus3));
	D3DXMatrixRotationY(&matR1, -각도(plus3));
	D3DXMatrixRotationZ(&matZ, 각도(30.0f));
	D3DXMatrixRotationZ(&matZ1, -각도(30.0f));
...
void EffectClass::ToneRender(D3DXMATRIXA16 * trans)
{
	...
	D3DXMatrixRotationY(&matR, 각도(plus2));
	D3DXMatrixRotationZ(&matR2, -각도(plus2));
	D3DXMatrixRotationZ(&matR3, 각도(plus2));
	D3DXMatrixTranslation(&matTT, 0, -2, 0);
	D3DXMatrixScaling(&matSS, 0.02 + plus, 0.02, 0.02 + plus);
