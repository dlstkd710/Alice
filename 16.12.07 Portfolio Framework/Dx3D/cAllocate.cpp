...
STDMETHODIMP cAllocate::CreateFrame(THIS_ LPCSTR Name, LPD3DXFRAME *ppNewFrame)
{
...
STDMETHODIMP cAllocate::CreateMeshContainer(THIS_ LPCSTR Name,
...
STDMETHODIMP cAllocate::DestroyFrame(THIS_ LPD3DXFRAME pFrameToFree)
{
...
STDMETHODIMP cAllocate::DestroyMeshContainer(THIS_ LPD3DXMESHCONTAINER pMeshContainerToFree)
{
