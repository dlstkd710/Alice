...
void cOBB::Setup(cObjectXfile* xfile)
{
	D3DXVECTOR3 vMin = xfile->GetoMin();
	D3DXVECTOR3 vMax = xfile->GetoMax();
...
//void cOBB::Setup(cMtMesh * pMtMesh)
//{
//	//D3DXVECTOR3 vMin = pMtMesh->GetMin();
//	//D3DXVECTOR3 vMax = pMtMesh->GetMax();
//	//m_vOrgCenterPos = (vMin + vMax) / 2.f;
//	//
//	//m_vOrgAxisDir[0] = D3DXVECTOR3(1, 0, 0);
//	//m_vOrgAxisDir[1] = D3DXVECTOR3(0, 1, 0);
...
//}
//
//void cOBB::Setup(cObjectXfile* pObjMesh)
//{
//	//D3DXVECTOR3 vMin = pObjMesh->GetMin();
//	//D3DXVECTOR3 vMax = pObjMesh->GetMax();
//	//m_vOrgCenterPos = (vMin + vMax) / 2.f;
//	//
//	//m_vOrgAxisDir[0] = D3DXVECTOR3(1, 0, 0);
//	//m_vOrgAxisDir[1] = D3DXVECTOR3(0, 1, 0);
...
void cOBB::Setup(D3DXVECTOR3 pMin, D3DXVECTOR3 pMax)
{
	D3DXVECTOR3 vMin = pMin;
	D3DXVECTOR3 vMax = pMax;
	m_vOrgCenterPos = (vMin + vMax) / 2.f;
